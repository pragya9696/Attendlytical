...
### 1.By detecting student's image it will show whether a particular student is present or not and also by dectecting student's eye it will show the attentiveness         status of the students.
...
### 2.To help the students to read important topics of the lecture whenever they want, it generates the summary of lecture in text as well as in audio format.
...
### 3.To help the tutor to monitor students activity during lecture by providing a quantitative report to the instructor about the attentiveness of the classroom and each pupil along with timestamps. 
